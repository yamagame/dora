...
ドラスクリプトは、コミュケーションロボット用のスクリプトです。
...
- check
  ...
  payloadに指定した文字が含まれていればメッセージのプライオリティを増やします。追加されるプライオリティはデフォルトが10です。以下の様にして追加されるプライオリティを変更することもできます。
...
- switch
  ...
  payloadが指定した文字だったら指定したラベルへ制御を写します。
